...
// ========================================================================
void display_age_category(const string& name, int age);// Daniel Preller: Changed return type to correct type (void)
...
int main()
{
    ...
    // --------------------------------------------------------------------
    cout << "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n" << endl;// Daniel Preller: Added missing semicolon
...
bool is_exactly_twenty_one(int age)
{
    if (age == 21)// Daniel Preller: Changed assignment operator (=) to equality operator (==)
    {
        return true;
    }
    else
